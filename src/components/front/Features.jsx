export default function Features() {
  return (
    <section id="landingFeatures" className="section-py landing-features landing-faq bg-light-green">
      <div className="container">
        ...
        <p className="text-center mb-12">
          Your complete hub for listings, leads, visits, and broker collaboration.
        </p>
        <div className="features-icon-wrapper row gx-0 gy-6 g-sm-12">
          <div className="col-lg-6 col-sm-6 text-center features-icon-box">
          ...
          <div className="col-lg-6 col-sm-6 text-center features-icon-box">
            <div className="card h-100">
              <div className="card-body text-body d-flex flex-column justify-content-between h-100">
                <div className="mb-4 text-primary text-center">
                  <svg fill="#47B96D" height="200px" width="200px" version="1.1" viewBox="0 0 21.69 21.69" stroke="#47B96D" stroke-width="0.00021690000000000004"><g stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <path d="M21.267,12.833c0-4.332-5.576-6.527-8.831-3.576c-1.06-2.343-3.973-2.929-5.972-0.986 C5.186,6.107,1.768,6.203,0.679,8.507C0.51,8.867,0.424,9.254,0.424,9.673c0,0.04,0,5.301,0,5.301H5.47v2.244h5.373v4.472h10.423 C21.267,21.69,21.267,12.969,21.267,12.833z"></path> <circle cx="16.124" cy="3.558" r="3.558"></circle> <circle cx="9.007" cy="3.843" r="2.649"></circle> <circle cx="3.565" cy="4.208" r="1.958"></circle> </g> </g> </g></svg>

                </div>
                <h5 className="mb-2">Brokers CRM</h5>
                <p className="features-icon-description">
                  Track leads, notes, status updates & follow-ups.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="card h-100">
              <div className="card-body text-body d-flex flex-column justify-content-between h-100">
                <div className="text-center mb-4 text-primary">
                  <svg viewBox="0 0 24 24" fill="none" stroke="#47B96D"><g stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M3 9H21M7 3V5M17 3V5M6 12H8M11 12H13M16 12H18M6 15H8M11 15H13M16 15H18M6 18H8M11 18H13M16 18H18M6.2 21H17.8C18.9201 21 19.4802 21 19.908 20.782C20.2843 20.5903 20.5903 20.2843 20.782 19.908C21 19.4802 21 18.9201 21 17.8V8.2C21 7.07989 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V17.8C3 18.9201 3 19.4802 3.21799 19.908C3.40973 20.2843 3.71569 20.5903 4.09202 20.782C4.51984 21 5.07989 21 6.2 21Z" stroke="#47B96D" stroke-width="2" stroke-linecap="round"></path> </g></svg>
                </div>
                <h5 className="mb-2">Visit Tracking</h5>
                <p className="features-icon-description">
                  Schedule, track, manage property visits easily.
                </p>
              </div>
            </div>
          </div>
